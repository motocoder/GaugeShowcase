...
import com.ekndev.guagelibrary.FullGauge;
...
public class FullGaugeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflated = inflater.inflate(R.layout.full_guage_fragment, container, false);

        final FullGauge fullGauge = inflated.findViewById(R.id.full_guage);

...
public class HalfGaugeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflated = inflater.inflate(R.layout.half_guage_fragment, container, false);

        final HalfGauge arcGuage = inflated.findViewById(R.id.half_guage);

        arcGuage.setMaxValue(100);
        arcGuage.setMinValue(0);
        arcGuage.setValue(value);
        arcGuage.enableAnimation(false);

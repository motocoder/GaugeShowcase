...
import com.ekndev.guagelibrary.DoubleValueFormatterImpl;
import com.ekndev.guagelibrary.HalfGauge;
import com.ekndev.guagelibrary.RadialGauge;
...
public class RadialGaugeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflated = inflater.inflate(R.layout.radial_gauge_fragment, container, false);

        final RadialGauge arcGuage = inflated.findViewById(R.id.radial_gauge);
        ...
        arcGuage.setFormatter(new DoubleValueFormatterImpl(1));

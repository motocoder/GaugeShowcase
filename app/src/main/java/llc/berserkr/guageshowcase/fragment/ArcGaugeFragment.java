...
import com.ekndev.guagelibrary.ArcGauge;
...
public class ArcGaugeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflated = inflater.inflate(R.layout.arc_guage_fragment, container, false);

        final ArcGauge arcGuage = inflated.findViewById(R.id.arcGauge);

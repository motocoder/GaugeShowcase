...
public class RadialGauge extends AbstractGauge {
    ...
    private final float arcWidth = 30f;
    private float needleStart = -60;
    private float needleEnd = 240;
    ...
    public RadialGauge(Context context) {
        super(context);
        init();
    }

    public RadialGauge(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RadialGauge(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public RadialGauge(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        getGaugeBackGround().setStrokeWidth(arcWidth);
        //add BG Shadow
        //drawShadow();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.translate((getWidth() / 2f) - ((getRectRight() / 2f) * getScaleRatio()), getRectTop() * getScaleRatio());
        ...
        canvas.drawLine(-5f, 400f / 2f, 400f / 2f, 400f / 2f, getNeedlePaint());
